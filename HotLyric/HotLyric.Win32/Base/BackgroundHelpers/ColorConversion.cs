...
namespace HotLyric.Win32.Base.BackgroundHelpers
{
    public static class ColorConversion
    {
        ...
        public static double GetTintOpacityModifier(Color tintColor)
        {
            ...
            var rgb = (tintColor.R / 255.0, tintColor.G / 255.0, tintColor.B / 255.0);
        ...
        public static Color GetLuminosityColor(Color tintColor, double? luminosityOpacity)
        {
            ...
            else
            {
                ...
                var hsvLuminosityColor = (hsvTintColor.h, hsvTintColor.s, clampedHsvV);
                var rgbLuminosityColor = HsvToRgb(hsvLuminosityColor);
                ...
                return Color.FromArgb((byte)(Math.Min(mappedTintOpacity, 1.0) * 255),
                    (byte)(rgbLuminosityColor.r * 255),
                    (byte)(rgbLuminosityColor.g * 255),
                    (byte)(rgbLuminosityColor.b * 255));
            }
